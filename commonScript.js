          ...
          <div class="features flex flex-col">
            ...
            <div class="nestedLinks flex flex-col ml-4">
              ...
              <a class="flex group items-center relative font-semibold ease-in-out duration-300 pb relative after:content-[''] after:bottom-0 after:h-1 after:w-0 after:left-0 after:absolute after:bg-indigo-600 hover:after:w-full after:ease-in-out after:duration-300 "
                ...
                <span class="text-sm p-3 group-hover:text-indigo-600">Spiritual Events</span>
              </a>
  ...
  let footerContent = `
    <!-- NewsLetter  -->
          ...
          <div class="mt-8 siteNav flex flex-col lg:flex-row ">
            ...
            <div
              ...
              <a href=" ../Iskcon/event.html"
                 class="w-full text-center lg:text-right">
                <span
                      class="relative font-semibold ease-in-out duration-300 pb-1 relative after:content-[''] after:bottom-0 after:h-[2px] after:w-0 after:left-0 after:absolute after:bg-indigo-600 hover:text-indigo-600 hover:after:w-full after:ease-in-out after:duration-300 footer-link-text">Spiritual
                  Events</span>
              </a>
          ...
          <div class="mt-8 copyRight flex items-center justify-center text-xs text-slate-300 flex-col">
            <p class='text-center' style = "color:white;" >Made by Synery Six</p>
